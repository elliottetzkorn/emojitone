# EmojiTone ![next-themes minzip package size](https://img.shields.io/bundlephobia/minzip/emojitone) ![Version](https://img.shields.io/npm/v/emojitone.svg?colorB=green)
